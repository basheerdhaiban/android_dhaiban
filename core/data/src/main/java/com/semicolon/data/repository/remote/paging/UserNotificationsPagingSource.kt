...
class UserNotificationsPagingSource(private val notificationsRemoteSource: NotificationsRemoteSource) :
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, NotificationModel> {
        return try {
            ...
            val response = notificationsRemoteSource.getUserNotifications(
                page = currentPage
            ).data
